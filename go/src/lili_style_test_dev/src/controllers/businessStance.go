...
func GetBusinessStanceData(userdata []string, rowNum int, client *sheets.SheetClient) models.BusinessStance {
	...
	if client != nil {
		CheckRateCategory(client, answerInt, rowNum, "businessStance")
	}
